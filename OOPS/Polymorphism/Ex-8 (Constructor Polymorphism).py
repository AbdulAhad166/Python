#Program for Calculating Area of Different Shapes---using  Class Name Approach
class Circle:
...
class Rectangle(Square,Circle):
    def __init__(self):     #Overridden Method
        ...
        print("--------------------------------------------")
        Square.__init__(self)   #Class Name Approach
        Circle.__init__(self)   #Class Name Approach
#Main Program
